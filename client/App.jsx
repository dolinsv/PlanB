...
function NetIcon({ network }) {
  if (network === 'instagram') {
    // Camera glyph only — plate comes from CSS
    return (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path d="M12 8.2a3.8 3.8 0 1 0 0 7.6 3.8 3.8 0 1 0 0-7.6zm0 6.3a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5z" />
        <circle cx="16.85" cy="7.35" r="0.95" />
        <path d="M12 4.6c-2 0-2.25.01-3.04.04-1.9.09-2.95.98-3.04 3.04-.03.79-.04 1.04-.04 3.04s.01 2.25.04 3.04c.09 2.05 1.14 2.95 3.04 3.04.79.03 1.04.04 3.04.04s2.25-.01 3.04-.04c2.05-.09 2.95-1.14 3.04-3.04.03-.79.04-1.04.04-3.04s-.01-2.25-.04-3.04c-.09-2.05-1.14-2.95-3.04-3.04C14.25 4.61 14 4.6 12 4.6zm0 1.15c1.97 0 2.2.01 2.97.04 1.48.07 2.23.8 2.3 2.3.03.77.04 1 .04 2.97s-.01 2.2-.04 2.97c-.07 1.48-.83 2.23-2.3 2.3-.77.03-1 .04-2.97.04s-2.2-.01-2.97-.04c-1.48-.07-2.23-.83-2.3-2.3-.03-.77-.04-1-.04-2.97s.01-2.2.04-2.97c.07-1.48.83-2.23 2.3-2.3.77-.03 1-.04 2.97-.04z" />
      </svg>
    );
  }
  // VK letters only — no inner plate
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M3.6 7.4h2.3l2.35 5.7h.1l2.4-5.7h2.35v8.5H11.5v-4.85h-.1l-2.35 4.85H7.35L5 11.1h-.1v4.8H3.6V7.4zm9.9 0h2.7c1.75 0 2.9 1 2.9 2.6 0 1.2-.6 2.05-1.65 2.4l2.05 3.5h-2.35l-1.8-3.2h-.65v3.2h-2.2V7.4zm2.2 1.55v2.5h1.15c.75 0 1.2-.4 1.2-1.1s-.45-1.1-1.2-1.1H15.7z" />
    </svg>
  );
}
